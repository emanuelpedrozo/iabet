...
from app.api.routes import auth, matches, reports, admin
...
app.include_router(auth.router,prefix="/api/v1"); app.include_router(matches.router,prefix="/api/v1"); app.include_router(reports.router,prefix="/api/v1"); app.include_router(admin.router,prefix="/api/v1")
